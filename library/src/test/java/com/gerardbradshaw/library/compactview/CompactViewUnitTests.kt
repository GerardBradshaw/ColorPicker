...
import com.gerardbradshaw.library.compactview.CompactViewUnitTestUtil.SliderType
import com.gerardbradshaw.library.compactview.CompactViewUnitTestUtil.changeSliderTypeTo
import com.gerardbradshaw.library.util.InputParams
import com.gerardbradshaw.library.util.OutputColors
import com.gerardbradshaw.library.util.UnitTestUtil.checkPreviewChangedColorTo
import com.gerardbradshaw.library.util.UnitTestUtil.checkSeekBarIsAtProgress
import com.gerardbradshaw.library.util.UnitTestUtil.moveSeekBarTo
import com.gerardbradshaw.library.util.UnitTestUtil.sliderMax
  ...
  class SingleTests {
    ...
    fun setUp() {
      ...
      val layout = LayoutInflater
        ...
        .inflate(R.layout.activity_layout_with_compact_view, null) as LinearLayout

      seekBar = layout.findViewById(R.id.slider_seek_bar)
      listener = layout.findViewById(R.id.ex_compact_listener)
      menu = layout.findViewById(R.id.compact_menu_frame)
    }
